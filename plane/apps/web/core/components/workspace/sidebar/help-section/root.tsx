  ...
  return (
    <>
      ...
      <CustomMenu
        ...
        closeOnSelect
      >
        <CustomMenu.MenuItem onClick={() => window.open(AGENTPM_DOCS_URL, "_blank")}>
        ...
        <CustomMenu.MenuItem onClick={() => window.open(AGENTPM_ROADMAP_URL, "_blank", "noopener,noreferrer")}>
          <div className="flex items-center gap-x-2 rounded-sm text-11">
            <span className="text-11">Roadmap</span>
          </div>
        </CustomMenu.MenuItem>
