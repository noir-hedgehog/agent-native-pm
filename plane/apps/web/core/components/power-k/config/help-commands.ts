...
export const usePowerKHelpCommands = (): TPowerKCommandConfig[] => {
  ...
  return [
    ...
    },
    {
      ...
      icon: FileText,
      action: () => {
        window.open(AGENTPM_DOCS_URL, "_blank", "noopener,noreferrer");
      },
      isEnabled: () => true,
      isVisible: () => true,
      closeOnSelect: true,
    },
    {
      ...
      icon: MessageSquare,
      action: () => {
        window.open(AGENTPM_ROADMAP_URL, "_blank", "noopener,noreferrer");
      },
      isEnabled: () => true,
      isVisible: () => true,
      closeOnSelect: true,
    },
    {
      ...
      icon: GithubIcon,
      action: () => {
        window.open(AGENTPM_NEW_ISSUE_URL, "_blank", "noopener,noreferrer");
      },
      isEnabled: () => true,
      isVisible: () => true,
      closeOnSelect: true,
