...
description: Use when an agent works with Plane through AgentPM Plane-native MCP, especially to choose project/member/state ids, create or update work items, add project members, or recover from MCP tool errors.
---

# AgentPM Plane Workflow
